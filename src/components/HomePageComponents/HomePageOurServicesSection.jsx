    ...
    <section className="bg-black py-16 sm:py-20 lg:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 xl:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start mb-16">
          <div>
            <h1 className="text-white font-inter-tight font-bold text-3xl sm:text-4xl md:text-5xl xl:text-6xl leading-tight tracking-[2px] max-w-full lg:max-w-xl text-center lg:text-left mx-auto lg:mx-0">
          ...
          <div className="flex justify-center lg:justify-end mt-4 lg:mt-0">
            <p className="text-white/80 font-inter-tight tracking-[2px] text-base sm:text-lg md:text-xl max-w-full lg:max-w-md text-center lg:text-left">
              Built for reflection, direction, and real-world progress.
            </p>
          </div>
        </div>
